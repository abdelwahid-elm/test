...
export const opportunities: Opportunity[] = [
  {
    ...
    property: {
      ...
      currentValuation: 365000,
      energyLabel: "C",
      riskScore: 2,
    },
    residentContribution: 165000,
    capitalRequired: 200000,
    committed: 120000,
    proposedStructure: {
      nl: "Model A — rechtstreekse mede-eigendom. De bewoner brengt €165.000 in, de familie zoekt nog €200.000 aan aanvullend kapitaal.",
      fr: "Modèle A — copropriété directe. L'occupant apporte 165 000 €, la famille recherche encore 200 000 € de capital complémentaire.",
    },
    proposedOccupancy: {
  ...
  },
  {
    ...
    property: {
      ...
      currentValuation: 285000,
      energyLabel: "B",
      riskScore: 2,
    },
    residentContribution: 140000,
    capitalRequired: 145000,
    committed: 60000,
    proposedStructure: {
  ...
  },
  {
    ...
    residentContribution: 350000,
    capitalRequired: 230000,
    committed: 230000,
    proposedStructure: {
