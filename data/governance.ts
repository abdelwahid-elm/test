...
export const governanceProposals: GovernanceProposal[] = [
  {
    id: "gov-vilvoorde-2",
    title: { nl: "Tweede woning aankopen in Vilvoorde voor €380.000", fr: "Acquérir un second bien à Vilvoorde pour 380 000 €" },
    memo: {
      nl: "Voorstel om een tweede familiewoning te verwerven in Vilvoorde, vlakbij de bestaande woning. Voorgestelde structuur: Model A, bewoner nog te bepalen. Vereist €210.000 aan aanvullend kapitaal bovenop de bijdrage van de toekomstige bewoner.",
      fr: "Proposition d'acquérir un second bien familial à Vilvoorde, à proximité du bien existant. Structure proposée : Modèle A, occupant à déterminer. Nécessite 210 000 € de capital complémentaire en plus de l'apport du futur occupant.",
    },
    requiredCapital: 210000,
