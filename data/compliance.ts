...
export const complianceRequirements: ComplianceRequirement[] = [
  ...
  { id: "cmp-2", category: "aml_kyc", label: { nl: "Herkomst van middelen gedocumenteerd", fr: "Origine des fonds documentée" }, status: "attention_required", propertyId: "prop-kortenberg", detail: { nl: "Documentatie voor de inbreng van Fatima Zahra Toumi ontbreekt nog.", fr: "La documentation de l'apport de Fatima Zahra Toumi manque encore." } },
